...
float train_network_datum_gpu(network net, float *x, float *y, ocr_label_desc ocr_label);
...
void forward_backward_network_gpu(network net, float *x, float *y, ocr_label_desc ocr_label);
#endif
...
float train_network_datum(network net, float *x, float *y, ocr_label_desc ocr_label);
